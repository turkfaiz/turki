...
نظام لرصد عمداء مختارين، ثم مراجعة الموظف للوارد والمستبعد.
...
- **المصادر:** سجل مغلق حتى ثلاثة مواقع لكل مكتب (رسمي، محلي، وطني). محركات البحث معطّلة.
...
محركات البحث معطّلة بالحوكمة. الرصد يقرأ من سجل مصادر مغلق: ثلاثة نطاقات معتمدة لكل
مكتب بذرة في `src/sources.js`. المكتب المضاف من الإعدادات يخزّن حتى ثلاث منصات في D1
(غرفة رسمية ثم محلية ثم وكالة)، بلا Google/Bing/X، ويُفحص منها فقط. وإذا لم يوجد مفتاح Gemini تُوسم الأخبار بحالة صريحة تقول إن المفتاح
